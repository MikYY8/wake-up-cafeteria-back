...
categoriesRouter.post("/", categoryCreateValidation, validationMiddleware, createCategory)


//PUT (editar) datos en el body + id para saber cuál editar: actualiza un elemento especifico
categoriesRouter.put("/:id", categoryUpdateValidation, validationMiddleware, updateCategory)


//DELETE con un id: eliminar un elemento de la base de datos (logica (cambio de estado) / fisica (eliminacion real de la BBDD))
categoriesRouter.delete("/:id", idValidation, validationMiddleware, deleteCategory)
